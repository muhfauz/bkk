    ...
    <div class="user-panel">
      ...
      <div class="info">
        ...
        <?php } elseif ($this->session->userdata('posisi') == 'pelamar') { ?>
          ...
          <p>PELAMAR</p>
          <p>
            <small> <?php echo $this->session->userdata('acc_adminpelamar') ?> </small>
          </p>
        <?php } else { ?>
          <p>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if ($this->session->userdata('posisi') == 'admin') { ?>
        ...
        <li class="treeview"> <a href="#"> <i class="fa fa-database mr-2"></i> <span>Perusahaan</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="ml-4"><a href="<?php echo base_url('admin/master/perusahaanadmin') ?>"> <i class="fa fa-window-close mr-1"></i>Belum ACC</a></li>
            <li class="ml-4"><a href="<?php echo base_url('admin/master/perusahaanadmin/acc') ?>"> <i class="fa fa-check-square-o mr-1"></i> Perusahaan</a></li>
            <li class="ml-4"><a href="<?php echo base_url('admin/master/perusahaanadmin/ban') ?>"> <i class="fa fa-ban mr-1"></i>Banned</a></li>
        ...
        <li class="treeview"> <a href="#"> <i class="fa fa-database mr-2"></i> <span>Lowongan</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="ml-4"><a href="<?php echo base_url('admin/master/lowonganadmin') ?>"> <i class="fa fa-window-close mr-1"></i>Belum ACC</a></li>
            <li class="ml-4"><a href="<?php echo base_url('admin/master/lowonganadmin/acc') ?>"> <i class="fa fa-check-square-o mr-1"></i>Lowongan ACC</a></li>
        ...
        <li class="treeview"> <a href="#"> <i class="fa fa-file-pdf-o mr-2"></i><span>Laporan</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="ml-4"><a href="<?php echo base_url('admin/laporan/lperusahaan') ?>"> <i class="fa fa-history mr-1"></i>Data Perusahaan</a></li>
            <li class="ml-4"><a href="<?php echo base_url('admin/laporan/lpelamar') ?>"> <i class="fa fa-history mr-1"></i>Data Pelamar</a></li>
            <li class="ml-4"><a href="<?php echo base_url('admin/laporan/llowongan') ?>"> <i class="fa fa-history mr-1"></i>Data Lowongan</a></li>
          </ul>
        </li>
      ...
      <?php } elseif ($this->session->userdata('posisi') == 'perusahaan') { ?>
        <?php if ($this->session->userdata('acc_admin') == 'acc') { ?>
          ...
          <li class="treeview"> <a href="#"><i class="fa fa-cogs mr-2" aria-hidden="true"></i><span>Pengaturan</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">
              <li class="ml-4"><a href="<?php echo base_url('admin/pengaturan/datadiriperush') ?>"><i class="fa fa-user mr-2" aria-hidden="true"></i>Data Perusahaan</a></li>
