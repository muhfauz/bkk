                    ...
                    <tbody>
                        ...
                        foreach ($pelamar as $a) :  ?>
                            <tr>
                                ...
                                <td><?php if ($a->acc_adminpelamar == 'belum') { ?>
                                        <span class="badge badge-primary">Belum</span>

                                    <?php } elseif ($a->acc_adminpelamar == 'acc') { ?>
                                ...
                                <td class="float-right">
                                    ...
                                    <?php if ($a->acc_adminpelamar == 'belum') { ?>
                                        <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#accdata<?php echo $a->kd_pelamar ?>"> <i class="fa fa-check-square-o mr-2"></i> ACC</a>
                                        <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#banneddata<?php echo $a->kd_pelamar ?>"> <i class="fa fa-ban mr-2"></i> Banned</a>


                                    <?php } elseif ($a->acc_adminpelamar == 'acc') { ?>
                                        <!-- <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#accdata<?php echo $a->kd_pelamar ?>"> <i class="fa fa-edit mr-2"></i> ACC</a -->
                                        <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#banneddata<?php echo $a->kd_pelamar ?>"> <i class="fa fa-ban mr-2"></i> Banned</a>
...
<?php foreach ($pelamar as $a) : ?>
    <div class="modal fade" id="accdata<?php echo $a->kd_pelamar ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/master/pelamaradmin/accpelamar') ?>" method="post">
                        <div class="form-group">
...
<?php endforeach; ?>
<?php foreach ($pelamar as $a) : ?>
    <div class="modal fade" id="banneddata<?php echo $a->kd_pelamar ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/master/pelamaradmin/bannedpelamar') ?>" method="post">
                        <div class="form-group">
