  ...
  <div class="content">
    ...
    <div class="info-box">
      ...
      <div class="table-responsive">
        ...
        <a href="" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahdata"> <i class="fa fa-plus-square mr-2"></i> Tambah </a>
            ...
            foreach ($admin as $a) :  ?>
              <tr>
                ...
                <td class="float-right">
                  <?php if ($a->kd_admin == 'ADM001') { ?>
                    <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_admin ?>"> <i class="fa fa-info-circle mr-2"></i> Detail</a>
                    <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editdata<?php echo $a->kd_admin ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('admin/master/admin/aksitambahadmin') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input name="gambar_admin" type="file" class="form-control">
          </div>
          <div class="form-group">
