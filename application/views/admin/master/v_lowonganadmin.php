                        ...
                        foreach ($lowongan as $a) :  ?>
                            <tr>
                                ...
                                <td class="float-right">
                                    ...
                                    <?php if ($a->acc_adminlowongan == 'belum') { ?>
                                    ...
                                    <?php } else { ?>
                                        <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#noaccdata<?php echo $a->kd_lowongan ?>"> <i class="fa fa-edit mr-2"></i> Tolak ACC </a>
                                    <?php } ?>
...
<?php foreach ($lowongan as $a) : ?>
    ...
    <div class="modal fade" id="noaccdata<?php echo $a->kd_lowongan ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> ACC Lowongan</h5>
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/master/lowonganadmin/noacclowongan') ?>" method="post">
                        <div class="form-group">
                            Apakah Anda Yakin akan Tidak di ACC data ini ?
                            <!-- <label for="">Nama</label>
          <input name="nama_karyawan" type="text" class="form-control" value="<?php echo $a->nama_karyawan ?>" required> -->
                            <input name="kd_lowongan" type="hidden" class="form-control" value="<?php echo $a->kd_lowongan ?>" required>
                        </div>
