                    ...
                    <tbody>
                        ...
                        foreach ($slider as $a) :  ?>
                            <tr>
                                ...
                                <td><img class="img-fluid" width="300" height="100" src="<?php echo base_url('depan/assets/image/banner/') . $a->gambar_slider ?>" alt="">
                                </td>
                ...
                <div class="modal-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>Foto slider</th>
                            <td>
                                <img width="300" height="100" src="<?php echo base_url('depan/assets/image/banner/') . $a->gambar_slider ?>" alt="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/pengaturan/slider/aksieditslider') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Foto slider</label>
                            <img class="form-control img-fluid mb-1" src="<?php echo base_url('depan/assets/image/banner/') . $a->gambar_slider ?>" alt="">
                            <input name="gambar_slider" type="file" class="form-control">
