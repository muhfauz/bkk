          ...
          <tbody>
            ...
            foreach ($bkk as $a) :  ?>
              <tr>
                ...
                <td>
                  <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editlogob<?php echo $a->kd_bkk ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
                </td>
                <td><img src="<?php echo base_url() ?>assets/img/<?php echo $a->logok_bkk ?>" alt=""></td>
                <td>
                  <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editlogok<?php echo $a->kd_bkk ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
                </td>
                </td>
                <td><img src="<?php echo base_url() ?>assets/img/<?php echo $a->logo_depan ?>" alt=""></td>
                <td>
                  <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editlogdepan<?php echo $a->kd_bkk ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
                </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('bkk/master/bkk/aksitambahbkk') ?>" method="post">
          <div class="form-group">
            <label for="">Nama</label>
            <input name="nama_bkk" type="text" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="">Username</label>
            <input name="username_bkk" type="text" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="">Password</label>
            <input name="password_bkk" type="password" class="form-control" required>
          </div>
...
<?php foreach ($bkk as $a) : ?>
  ...
  <div class="modal fade" id="editlogob<?php echo $a->kd_bkk ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col-md-4">
              <form action="<?php echo base_url('admin/pengaturan/logo/aksieditlogo') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input name="kd_bkk" type="hidden" class="form-control" value="<?php echo $a->kd_bkk ?>" required>
                  <input name="logob_bkk" type="file" class="form-control" value="<?php echo $a->logob_bkk ?>">
...
<?php foreach ($bkk as $a) : ?>
  ...
  <div class="modal fade" id="editlogok<?php echo $a->kd_bkk ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-aqua">
            ...
            <div class="col-md-4">
              <form action="<?php echo base_url('admin/pengaturan/logo/aksieditlogok') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input name="kd_bkk" type="hidden" class="form-control" value="<?php echo $a->kd_bkk ?>" required>
                  <input name="logok_bkk" type="file" class="form-control" value="<?php echo $a->logob_bkk ?>">
...
<?php foreach ($bkk as $a) : ?>
  ...
  <div class="modal fade" id="editlogdepan<?php echo $a->kd_bkk ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-aqua">
          <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-building mr-2"></i> Form Edit Logo Kecil</h5>
