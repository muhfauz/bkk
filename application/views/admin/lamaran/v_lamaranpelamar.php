                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#lihatlamaran<?php echo $a->kd_lamaran ?>"> <i class="fa fa-upload mr-2" aria-hidden="true"></i></i> Lihat Berkas</a>

                                    <?php } ?>
                                </td>
                                <td><?php if ($a->status_lamaran == 'belum') { ?>
                                        <span class="badge badge-primary">Belum Upload Berkas Lamaran</span>

                                    <?php } elseif ($a->status_lamaran == 'sudah') { ?>

                                        <span class="badge badge-success"> Menunggu Seleksi </span>
                                    <?php } else { ?>
