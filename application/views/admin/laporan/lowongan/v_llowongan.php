    ...
    <div class="content">
        <div class="info-box">
            ...
            <div class="table-responsive">
                ...
                <a href="<?php echo base_url('admin/laporan/llowongan/laporan_pdf_lowongan') ?>" class="btn btn-secondary bg-aqua-gradient mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
