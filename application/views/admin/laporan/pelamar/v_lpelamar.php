    ...
    <div class="content">
        <div class="info-box">
            ...
            <div class="table-responsive">
                ...
                <a href="<?php echo base_url('admin/laporan/lpelamar/laporan_pdf_pelamar') ?>" class="btn btn-secondary bg-aqua-gradient mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
