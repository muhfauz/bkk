                        ...
                        <div class="appont_sec_inner bg-black">
                            ...
                            <?php foreach ($perusahaan as $p) : ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <span><?php echo $p->kd_perush ?></span>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        Nama
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <span><?php echo $p->nama_perush ?></span>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        Alamat
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <span><?php echo $p->alamatlengkap_perush ?></span>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        Password
                                    </div>
