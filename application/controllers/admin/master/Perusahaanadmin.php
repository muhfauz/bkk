...
class Perusahaanadmin extends CI_Controller
{
  ...
  function index()
  {
    ...
    $data['perusahaan'] = $this->db->query("select * from tbl_perusahaan where acc_admin='belum'")->result();
    // $data['jabatan'] = $this->Mglobal->tampilkandata('tbl_jabatan');
    // $data['bagian'] = $this->Mglobal->tampilkandata('tbl_bagian');
    $this->load->view('admin/temp/v_header', $data);
    $this->load->view('admin/temp/v_atas');
    $this->load->view('admin/temp/v_sidebar');
    $this->load->view('admin/master/v_perusahaanadmin');
    $this->load->view('admin/temp/v_footer');
  }
  function acc()
  {
    $data['x1'] = 'Data Perusahaan ACC';
    $data['x2'] = 'Master';
    $data['x3'] = 'Perusahaan';
    $data['x4'] = 'Data Perusahaan ' . '| ' . $this->db->query('select nama_bkk from tbl_bkk')->row()->nama_bkk;
  ...
  function ban()
  {
    ...
    $data['x3'] = 'Perusahaan';
    $data['x4'] = 'Data Perusahaan ' . '| ' . $this->db->query('select nama_bkk from tbl_bkk')->row()->nama_bkk;
    $data['perusahaan'] = $this->db->query("select * from tbl_perusahaan where acc_admin='banned'")->result();
    // $data['jabatan'] = $this->Mglobal->tampilkandata('tbl_jabatan');
    // $data['bagian'] = $this->Mglobal->tampilkandata('tbl_bagian');
    $this->load->view('admin/temp/v_header', $data);
    $this->load->view('admin/temp/v_atas');
  ...
  function accperusahaan()
  {
    ...
    redirect(base_url('admin/master/perusahaanadmin/'));
  }
  function bannedperusahaan()
  {
    ...
    redirect(base_url('admin/master/perusahaanadmin/acc'));
  }
}
