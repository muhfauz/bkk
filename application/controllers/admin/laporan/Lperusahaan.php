...
class Lperusahaan extends CI_Controller
{
  ...
  function index()
  {
    $data['x1'] = 'Laporan Data Perusahaan';
    $data['x2'] = 'Laporan';
    $data['x3'] = 'Perusahaan';
    ...
    $this->load->view('admin/laporan/perusahaan/v_lperusahaan');
    $this->load->view('admin/temp/v_footer');
  }
  function laporan_pdf_perusahaan()
  {
    ...
    $this->pdf->load_view('admin/laporan/perusahaan/vlaporanpdfperusahaan', $data);
